 ...
 * [решено] см. [multiarc](https://github.com/VPROFi/multiarc) вдруг выяснилось, что far2l не поддерживает запароленные 7z архивы (в целом понятно почему - в исходниках только Си шные файлы для распаковки)
